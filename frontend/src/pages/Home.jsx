...
function App() {
  return (
    <div className="flex flex-col gap-11 items-center justify-center min-h-screen bg-gray-100">
      {/* Spinning cogwheel with framer-motion */}
      ...
      {/* Maintenance message */}
      <h1 className="text-4xl text-center italic">Our website is under maintenance</h1>
    </div>
  );
}
